...
mainFrame.Size                   = UDim2.new(0, 440, 0, 640)
...
------------------------------------------------------
-- SCRIPTS PANEL (RSP / EXPLORE / NET)
------------------------------------------------------
do
    local scriptsDiv = Instance.new("Frame")
    scriptsDiv.Size             = UDim2.new(1, -32, 0, 1)
    scriptsDiv.Position         = UDim2.new(0, 16, 0, 224)
    scriptsDiv.BackgroundColor3 = COL.border
    scriptsDiv.BorderSizePixel  = 0
    scriptsDiv.Parent           = mainFrame

    local scriptsLbl = Instance.new("TextLabel")
    scriptsLbl.Size               = UDim2.new(0, 100, 0, 16)
    scriptsLbl.Position           = UDim2.new(0, 16, 0, 228)
    scriptsLbl.BackgroundTransparency = 1
    scriptsLbl.Text               = "SCRIPTS"
    scriptsLbl.Font               = Enum.Font.Code
    scriptsLbl.TextSize           = 11
    scriptsLbl.TextColor3         = COL.subtext
    scriptsLbl.TextXAlignment     = Enum.TextXAlignment.Left
    scriptsLbl.Parent             = mainFrame

    local scriptsPanel = Instance.new("Frame")
    scriptsPanel.Size               = UDim2.new(1, -32, 0, 48)
    scriptsPanel.Position           = UDim2.new(0, 16, 0, 246)
    scriptsPanel.BackgroundColor3   = COL.panel
    scriptsPanel.BackgroundTransparency = 0.1
    scriptsPanel.BorderSizePixel    = 0
    scriptsPanel.Parent             = mainFrame
    mkCorner(10, scriptsPanel)
    mkStroke(1, COL.border, 0, scriptsPanel)

    local lsBtnData = {
        { label = "RSP",     url = "https://rawscripts.net/raw/Universal-Script-RemoteSpy-for-Xeno-and-Solara-32578" },
        { label = "EXPLORE", url = "https://rawscripts.net/raw/Universal-Script-NDex-V1-Dark-Dex-76941" },
        { label = "NET",     url = "https://raw.githubusercontent.com/vetrexian/universal/refs/heads/main/message%20(2).txt" },
    }
    ...
    for i, info in ipairs(lsBtnData) do
        ...
        btn.Position         = UDim2.new(0, startX + (i - 1) * (btnW + 8), 0.5, -16)
...
do
    ...
    div.Position         = UDim2.new(0, 16, 0, 292)
    div.BackgroundColor3 = COL.border
    div.BorderSizePixel  = 0
    ...
    lbl.Position           = UDim2.new(0, 16, 0, 300)
    lbl.BackgroundTransparency = 1
    lbl.Text               = "PLAYERS"
    lbl.Font               = Enum.Font.Code
    lbl.TextSize           = 11
...
scroll.Size                   = UDim2.new(1, -32, 1, -326)
scroll.Position               = UDim2.new(0, 16, 0, 320)
